        ...
        <div className="bg-fara-teal grid min-h-screen place-items-center px-5 py-16 text-white md:px-20">
            <div className="grid gap-8 text-center md:grid-cols-3">
                <div className="flex h-full flex-col items-center gap-5">
                    ...
                    <h3 className="text-2xl font-bold drop-shadow-[0.7px_0.7px_0.7px_black] lg:text-3xl">
                        CAPACITACIONES
                    </h3>
                    ...
                    >
                        <div className="skew-custom text-md bg-fara-teal px-6 py-1.5 font-bold drop-shadow-[0.7px_0.7px_0.7px_black] transition-colors duration-300 ease-in-out group-hover:bg-black group-focus:bg-black">
                ...
                <div className="flex h-full flex-col items-center gap-5">
                    ...
                    <h3 className="text-2xl font-bold drop-shadow-[0.7px_0.7px_0.7px_black] lg:text-3xl">SERVICIOS</h3>
                    <p className="text-md flex-grow font-bold drop-shadow-[0.7px_0.7px_0.7px_black]">
