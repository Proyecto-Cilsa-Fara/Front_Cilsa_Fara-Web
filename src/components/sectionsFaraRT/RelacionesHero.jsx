...
export function RelacionesHero() {
  const TITLE = "Restaurando las relaciones laborales";
  const DESCRIPTION =
    "Un enfoque restaurativo para transformar los conflictos laborales en oportunidades de crecimiento, fortaleciendo el clima organizacional y promoviendo entornos de trabajo saludables y productivos.";
  ...
  return (
    <section className="w-full">
      <div className="bg-relaciones-labores-image relative flex h-dvh w-full flex-col items-center justify-center gap-4 md:h-80 lg:h-150 xl:h-170">
