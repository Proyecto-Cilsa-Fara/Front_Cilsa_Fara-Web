            ...
            <div className="container flex items-center justify-between">
                ...
                <div className="flex gap-8">
                    ...
                    <div className="hidden gap-4 md:flex">
                        <button className="skew-custom min-h-12 min-w-48 bg-blue-500 py-2 pr-8 pl-6 text-white uppercase hover:bg-blue-600">
                            <p className="text-xl font-bold drop-shadow-[0.7px_0.7px_0.7px_black]">Doná</p>
                        </button>
                        <button className="skew-custom min-h-12 min-w-48 bg-red-700 py-2 pr-8 pl-6 text-white hover:bg-red-800">
            ...
            {isOpen && (
                <ul className="mt-4 flex flex-col gap-2 font-bold uppercase md:hidden">
                    ...
                    <li className="self-center">
                        <button className="skew-custom min-h-12 min-w-48 bg-blue-500 pr-8 pl-6 text-white uppercase hover:bg-blue-600">
                            <p className="text-xl font-bold drop-shadow-[0.7px_0.7px_0.7px_black]">Doná</p>
                        </button>
                    </li>
                    <li className="self-center">
                        <button className="skew-custom min-h-12 min-w-48 bg-red-700 pr-8 pl-6 text-white hover:bg-red-800">
                            <p className="text-xl font-bold drop-shadow-[0.7px_0.7px_0.7px_black]">Participá</p>
                        </button>
                    </li>
                </ul>
