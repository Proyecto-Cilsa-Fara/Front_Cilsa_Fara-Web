...
export function Noticias() {
  return (
    <section className="py-12">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-32 lg:py-32 text-center">
        <h2 className="skew-custom bg-fara-blue mb-3 text-2xl font-extrabold text-balance lg:text-3xl lg:font-bold uppercase inline-block px-8 py-2 text-white m-auto">
        ...
        <div className="grid gap-4 mt-11 md:grid-cols-2 xl:grid-cols-3 text-start">
