...
export function ParticipaHero() {
    const TITLE = "Pasantías y voluntariados"
    const DESCRIPTION =
        "Participá en cualquiera de nuestras áreas de incidencia a través de nuestros programas de pasantías y voluntariado."
